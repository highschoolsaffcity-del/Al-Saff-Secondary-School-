  ...
  const dict = {
    ...
    ar: {
      ...
      "hero.sub":
        ...
        "مناهج حديثة، أنشطة،ومجتمع متنوع يدعم طلابنا للتميّز",
      ...
      "about.body":
        ...
        "مدرسة الصف الثانوية المشتركة تقدّم برامج وطنية مع تركيز على القيم والتميز المدرسة والأنشطة",

      "programs.title": "البرامج المدرسية",
      ...
      "calendar.note":
        ...
        "هذا التقويم يُسحب تلقائيًا من Google Calendar",
      ...
      "contact.note": " سنعرض رسالة تأكيد فورية"
